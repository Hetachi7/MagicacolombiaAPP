...
class DepaQuindio : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_quindio)

        val CardAmaOpen: CardView = findViewById(R.id.Quindio1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Quindio2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Quindio3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Quindio4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Quindio5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Quindio6card)
